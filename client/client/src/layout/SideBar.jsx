...
import { logout, resetAuthSlice } from "../store/slices/authSlice"; // ✅ adjust import path
import AddNewAdmin from "../popups/AddNewAdmin";
// ✅ make sure this file exists
import UpdateCredentials from "../popups/UpdateCredentials";
...
const SideBar = ({ isSideBarOpen, setIsSideBarOpen, setSelectedComponent }) => {
  ...
  return (
    <>
      ...
      {addNewAdminPopup && (
        <div className="fixed top-0 left-64 w-[calc(100%-16rem)] bg-white h-full z-20 flex justify-center items-start pt-20">
          <h1 className="text-xl font-bold">ADD NEW ADMIN POPUP</h1>
          <AddNewAdmin />
        </div>
      )}
      {settingPopup && (
